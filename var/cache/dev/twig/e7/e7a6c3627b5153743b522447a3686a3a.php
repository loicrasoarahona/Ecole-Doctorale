...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Debug/Profiler/dump.html.twig", "/Users/loicrasoarahona/Documents/Symfony projects/ecole_doctorale/vendor/symfony/debug-bundle/Resources/views/Profiler/dump.html.twig");
    }
}
